  ...
  const tools = [
    {
      ...
      description:
        "Get a bird's eye view of your productivity metrics and daily progress",
      useCases: [
    ...
    },
    {
      ...
      description:
        "Pomodoro timers, stopwatch, and countdown tools to maximize your concentration",
      useCases: [
    ...
    },
    {
      ...
      description:
        "Organize and track your tasks efficiently with our smart task manager",
      useCases: [
    ...
    },
    {
      ...
      description:
        "Track your calories and maintain a healthy lifestyle while staying productive",
      useCases: [
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4">
        ...
        >
          <div className="relative inline-block">
            ...
            <Sparkles
              className="absolute -bottom-6 -right-6 md:-bottom-8 md:-right-8 h-6 w-6 md:h-8 md:w-8 text-secondary animate-pulse"
          ...
          <p className="text-xl md:text-3xl text-foreground/80 max-w-2xl mx-auto font-light">
            Your all-in-one productivity suite to stay focused, organized, and
        ...
        <div className="max-w-6xl mx-auto space-y-32">
          <div className="text-center space-y-4 mb-20">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Six powerful tools designed to boost your productivity and
              maintain balance
            </p>
          </div>
      ...
      <section className="py-32 px-4 relative">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-8 relative">
          ...
          <p className="text-xl text-muted-foreground">
            Join thousands of users who have supercharged their workflow with
            Focus Flow
          </p>
          <Button
            size="lg"
