  ...
  const handleSessionComplete = async () => {
    ...
    if (isWorkSession && sessionStartTime) {
      ...
      try {
        ...
        console.error("Error logging pomodoro time:", error);
        alert("Error: Could not save your pomodoro session."); // Replaced toast
      }
      // --- End of replacement ---

      alert("Work session complete! Time for a break."); // Replaced toast
    } else {
      alert("Break complete! Ready for another session?"); // Replaced toast
    }
